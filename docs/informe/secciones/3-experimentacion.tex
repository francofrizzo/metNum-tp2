...
.
            ...
            \subsubsection*{Resultados}
                \begin{figure}
                    \begin{center}
                        ...
                        \end{tabular}
                         \label*{El gráfico de la izquierda corresponde al ranking de la AFA con una única fecha, el del centro contiene 5 fechas y por último, el gráfico de la derecha contiene las 23 fechas de la liga.}
                \end{figure}
        ...
        En la liga 2 el equipo 1 le gana a todos menos con el 6 que empata. El equipo 6 pierde con todos menos con el 1 que empata. El equipo 2 le gana al 5 y al 3 y pierde con el 4. El 3 le gana al 4 y al 5 y pierde con el 2. El 4 gana contra el 2 y pierde con el 3 y el 5. Por último el 5 gana contra el 4 y pierde contra el 2 y el 3.
            \begin{figure}[h]
                \begin{center}
                    \begin{tabular}{@{\extracolsep{2cm}} cc}
                      \includegraphics{imagenes/liga2.odg} 
                      {\small \strong{liga 2}} \\
                    \end{tabular}
                \end{center}
        ...
        En la liga 4 el equipo 1 gana con todos los que juega excepto cuando juega con el 6 que empata. El equipo 6 empata todos. El resto de los equipos quedan iguales que en la liga 2.
            ...
            \begin{figure}[h]
                \begin{center}
                    \begin{tabular}{@{\extracolsep{2cm}} cc}
                      \includegraphics{imagenes/liga4.odg} \\
                      {\small \strong{liga 4}} \\
                    \end{tabular}
                \end{center}
        ...
        Por último en la liga 5 el equipo 1 gana con todos los que juega excepto cuando juega con el 6 que empata. El equipo 6 empata todos. El equipo 3 pierde con todos los que juega excepto cuando juega contra el 6 que empata. El resto de los equipos quedan iguales que en la liga 2.
         ...
         \begin{figure}[h]
                \begin{center}
                    \begin{tabular}{@{\extracolsep{2cm}} cc}
                      \includegraphics{imagenes/liga5.odg} 
                      {\small \strong{liga 5}}
                    \end{tabular}
                \end{center}
            ...
            \subsubsection*{Resultados}
             ...
             \begin{figure}
                \begin{center}
                    ...
                    \end{tabular}
                    \label*{El gráfico de la izquierda corresponde a la liga 2, el del centro a la liga 4 y el de la derecha a la liga 5.}
            \end{figure}
            ...
            \begin{figure}
                \begin{center}
                    ...
                    \begin{tabular}{ccc}
                        \includegraphics{graficos/exp3-partidos-liga2-C.pdf} & \includegraphics{graficos/exp3-partidos-liga4-C.pdf} &
                        \includegraphics{graficos/exp3-partidos-liga5-C.pdf}}
                    \end{tabular}
                    \label*{El gráfico de la izquierda corresponde a la liga 2, el del centro a la liga 4 y el de la derecha a la liga 5.}
            \end{figure}
